...
<head>
  <!-- 
    Team Eangle Solutions
     Date: 05/5/2015
  -->

  <title>Save the Wolves</title>	
...
<header>
  <p><img src="images/dorm3.bmp" alt="Dorm building" class = "center"  /></p>
</header>
  
  <h1 id="top">Room Selection System</h1>

  <nav>
		<ul>
     <li><a href = "login.html">Login</a></li>
	 <li><a href = "newUser.html">Sign Up Student</a></li>  
	 	</ul>
  </nav>

</br></br></br></br></br><aside class="right">

  <h3>Frequently Asked Questions</h3>
  </br></br><img src="images/farmlogo.bmp" class = "displayed" />
  <ul class = "li">
...
<div class="inner">
<div class="entry">
	  <figure><img src="images/dorm1.jpg"  />
	  
	  </figure>
	  </div>
<div class="entry">
      <figure><img src="images/dorm2.bmp"  />
      </figure>
	  </div>
<div class="entry">
	  <figure><img src="images/dorm3.bmp"  />
	  </figure>
	  </div>
   
      <div class="entry">
	  <figure><img src="images/dorm4.bmp"  />
	  </figure>
	  </div>
	 
	  <div class="entry">
	  <figure><img src="images/dorm5.bmp"  />
      </figure>
	  </div>
   ...
   </br></br><h3>Welcome To Residence Life!</h3>
...
Thank you for your interest in residing at Farmingdale State College.  We look forward to being part of this wonderful experience..</p>
  ...
  <p><img src="images/dorm2.bmp" alt="Dorm building" class="left" /></p>

  
  </br></br></br><h3>Residence Hall Eligibility Policy</h3>
...
Students will be notified by Residence Life once an application is received.  Correspondence will follow giving information on status, room assignment, check-in day, and other information that is important for resident students to know.  </p>
   ...
   </br></br></br><h3>Room and Board Refunds for Military Service</h3>
  <p class = "letter">
