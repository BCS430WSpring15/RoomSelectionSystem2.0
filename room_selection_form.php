    ...
    <div id="site_content">
        ...
        <table>
          ...
          <tr>
            ...
            <td>Date: <input id="proxysignaturedate" type="text" class="text" /></td>
          </tr>
        </table>
        ...
        <tr>
            ...
            <td>Roomate: <input id="rommatei" type="text" class="text" /></td>
          </tr>
          <tr>
            <td>Section B: Suite/Room preference II:</td><td><input id="preferenceii" type="text" class="text" /></td>
            <td>Roomate: <input id="rommateii" type="text" class="text" /></td>
          </td>
        </tr>
        </table>
